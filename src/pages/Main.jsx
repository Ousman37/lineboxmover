...
function Main() {
  return (
    <>
      <section
        id='headline'
        className='relative bg-slate-100 overflow-hidden dark:bg-slate-800'>
        <div className='absolute inset-x-0 top-0 bg-slate-900/5 h-px dark:bg-slate-100/5' />
        <div
          className='container flex items-center justify-center mx-auto px-4 max-w-8xl h-screen'
          style={{
            ...
            <div
              ...
              <div className='card-content md:w-1/2 p-8'>
                <p className='card-text text-lg md:text-xl lg:text-2xl'>
                  ...
                  så stressfri og praktisk som mulig. Enten du flytter innenfor
                  samme by eller på tvers av landet, er vi her for deg. Våre
                ...
                <ul className='custom-icon-list list-none mt-6'>
                  ...
                  <li className='custom-icon-list-item flex items-center mb-4'>
                    <FaCheck className='check-icon mr-2' />
                    <span className='custom-icon-list-text text-lg md:text-xl lg:text-2xl'>
                      Alt-i-ett flytteløsninger, inkludert midlertidig lagring,
                      flytterengjøring, pakking og avfallshåndtering
                    </span>
                  </li>
                </ul>
              </div>
            ...
            <div className='grid grid-cols-1 md:grid-cols-3 gap-8'>
              <div className='card shadow-lg'>
                <div className='card-content p-8'>
                  <h3 className='text-blue-500 md:text-xl'>
                  ...
                  <p className='card-text text-base sm:text-lg md:text-xl lg:text-2xl text-gray-500'>
                    ...
                    vi pris på om du kan gi oss så mye informasjon som mulig om
                    oppdraget ditt når du fyller ut kontaktskjemaet.
                  </p>
                </div>
              </div>
              <div className='card shadow-lg'>
        ...
        <section
          ...
          <div className='container mx-auto px-4'>
            <div
              ...
              <div className='card-content md:w-1/2 p-8'>
                <p className='card-text text-lg md:text-xl lg:text-2xl'>
                  Leter du etter et pålitelig flyttebyrå i Oslo eller Viken? Søk
                  ikke lenger enn Linebox. Vi spesialiserer oss på å tilby
                  omfattende flyttetjenester for alle typer flyttinger, enten de
                  er store eller små. Fra pakking og transport til rengjøring og
                  avfallshåndtering, kan vi håndtere alle aspekter av flyttingen
                  i henhold til dine spesifikke behov. Vi forstår at flytting
                  kan være en skremmende oppgave, derfor tilbyr vi ekstra
                  tjenester som flyttevask og møbeloppbevaring for å forenkle
                  prosessen for deg. Som et av de best rangerte flyttebyråene i
                  Oslo, er vi forpliktet til å sikre en jevn og stressfri
                  flytteopplevelse for alle våre kunder. Enten du trenger hjelp
                  med en husstandsflytting eller opprydning av en eiendom, kan
                  du stole på oss for å gi den ekspertisen og støtten du trenger
                  for å få flyttingen din til å bli vellykket. Kontakt oss i dag
                  for å lære mer om våre tjenester og hvordan vi kan hjelpe deg
                  med din flytting.
                </p>
                <a
                  href='/'
